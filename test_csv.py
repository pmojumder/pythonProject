...
def driver1():
    ...
    service = Service("C:\\Users\\Plabani\\Downloads\\chromedriver-win64 (1)\\chromedriver-win64\\chromedriver.exe")  # Update the path
...
def test_example(driver1):
    ...
    csv_file_path = r"C:\Users\Plabani\Downloads\Performance\Book2.csv"
